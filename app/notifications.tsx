...
function getNotificationColors(type: NotificationType): { bg: string; icon: string } {
  switch (type) {
    case NotificationType.ApplicationAccepted:
      return { bg: '#f0fdf4', icon: '#16A34A' };
    case NotificationType.ApplicationRejected:
      return { bg: '#fff5f5', icon: '#ef4444' };
    case NotificationType.JobCompleted:
      return { bg: '#eff6ff', icon: '#3b82f6' };
    case NotificationType.ReviewRequest:
      return { bg: '#fefce8', icon: '#eab308' };
    case NotificationType.NewJobRecommended:
      return { bg: '#f0fdf4', icon: '#16A34A' };
    default:
...
function getNotificationColorsDark(type: NotificationType): { bg: string; icon: string } {
  switch (type) {
    case NotificationType.ApplicationAccepted:
      return { bg: '#14532d', icon: '#4ade80' };
    case NotificationType.ApplicationRejected:
      return { bg: '#450a0a', icon: '#f87171' };
    case NotificationType.JobCompleted:
      return { bg: '#1e3a5f', icon: '#60a5fa' };
    case NotificationType.ReviewRequest:
      return { bg: '#422006', icon: '#fbbf24' };
    case NotificationType.NewJobRecommended:
      return { bg: '#14532d', icon: '#4ade80' };
    default:
      return { bg: '#1f2937', icon: '#9ca3af' };
  }
}
      ...
      >
        ...
        <TouchableOpacity
          style={[
            ...
            (unreadCount === 0 || markingAll) && styles.markAllDisabled,
          ]}

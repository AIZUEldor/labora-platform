...
namespace Labora.Infrastructure.Migrations
{
    ...
    [Migration("20260727102030_AddPropertyListings")]
    partial class AddPropertyListings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Labora.Domain.Entities.OtpAbuseEvent", b =>
                {
                    ...
                    b.HasIndex("DeviceHash", "EventType", "CreatedAt")
                        .HasDatabaseName("IX_OtpAbuseEvents_DeviceHash_EventType_CreatedAt");

                    b.HasIndex("IpHash", "EventType", "CreatedAt")
            ...
            modelBuilder.Entity("Labora.Domain.Entities.OtpVerification", b =>
                {
                    ...
                    b.Property<DateTime?>("OperationTokenExpiresAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("OperationTokenHash")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("Labora.Domain.Entities.PaymeTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<long?>("MerchantCancelTime")
                        .HasColumnType("bigint");

                    b.Property<long?>("MerchantCreateTime")
                        .HasColumnType("bigint");

                    b.Property<long?>("MerchantPerformTime")
                        .HasColumnType("bigint");

                    b.Property<int?>("PaymeStateCode")
                        .HasColumnType("integer");
                    ...
                    b.Property<long>("PaymeTransactionTime")
                        .HasColumnType("bigint");

                    b.Property<Guid>("PaymentOrderId")
                        .HasColumnType("uuid");

                    b.Property<long>("RequestedAmountTiyin")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("PaymeTransactionTime")
            ...
            modelBuilder.Entity("Labora.Domain.Entities.PropertyImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PropertyListingId", "SortOrder");

                    b.ToTable("PropertyImages");
                });

            modelBuilder.Entity("Labora.Domain.Entities.PropertyListing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Labora.Domain.Entities.Review", b =>
                {
                    ...
                    b.Property<int?>("WorkConditionRating")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Labora.Domain.Entities.PaymeTransaction", b =>
                {
                    b.HasOne("Labora.Domain.Entities.PaymentOrder", "PaymentOrder")
                        .WithMany()
            ...
            modelBuilder.Entity("Labora.Domain.Entities.PropertyImage", b =>
                {
                    b.HasOne("Labora.Domain.Entities.PropertyListing", "PropertyListing")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("Labora.Domain.Entities.PropertyListing", b =>
                {
                    b.HasOne("Labora.Domain.Entities.User", "Owner")
                        .WithMany()
